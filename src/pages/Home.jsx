  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 px-4 sm:px-6 py-6 lg:py-8 bg-gray-100 min-h-screen">
      ...
      <div className="flex-1">
        <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-gray-800 text-center lg:text-left flex items-center gap-2">
          <FaNewspaper /> Latest Blogs {selectedCategory && `- ${selectedCategory}`}
        </h2>
      ...
      <aside className="w-full lg:w-80 bg-white shadow-sm rounded-lg p-6 h-fit">
        {/* Recent Posts */}
        <div className="mb-8">
          <h3 className="text-lg font-semibold mb-3 text-gray-800 border-b pb-1 flex items-center gap-2">
